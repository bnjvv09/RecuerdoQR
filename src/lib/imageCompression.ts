...
export const comprimirImagen = compressImage;
export const comprimirImagenABlob = compressImageToBlob;
export const comprimirImagenAArchivo = compressImageToFile;
